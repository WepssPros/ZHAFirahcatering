<!-- START: ASIDE MENU BAWAH -->
<section class="" id="contact">
  <div class="border-t border-b border-gray-200 py-12 mt-16 px-4">
    <div class="flex justify-center mb-8">
      <img
        src="{{url('/zhafirahcatering-frontend/images/content/ZCLOGO.svg')}}"
    ...
    <aside class="container mx-auto">
      <div class="flex flex-wrap -mx-4 justify-center">
        <div class="px-4 w-full md:w-2/12 mb-4 md:mb-0 accordion">
          <h5 class="text-lg text-blue font-semibold mb-2 relative">Overview</h5>
          <ul class="h-0 invisible md:h-auto md:visible overflow-hidden">
            <li>
              <a href="#" class="hover:underline py-1 block text-blue-light"></a>
            </li>
            <li>
              <a href="#" class="hover:underline py-1 block text-blue-light">Refund</a>
            </li>
            <li>
              <a href="#" class="hover:underline py-1 block text-blue-light">Promotion</a>
            </li>
          </ul>
        </div>
        <div class="px-4 w-full md:w-2/12 mb-4 md:mb-0 accordion">
          <h5 class="text-lg font-semibold mb-2 relative text-blue ">Company</h5>
          <ul class="h-0 invisible md:h-auto md:visible overflow-hidden">
            <li>
              <a href="#" class="hover:underline py-1 block text-blue-light">About</a>
            </li>
            <li>
              <a href="#" class="hover:underline py-1 block text-blue-light">Career</a>
            </li>
            <li>
              <a href="#" class="hover:underline py-1 block text-blue-light">Contact Us</a>
            </li>
          </ul>
        </div>
        <div class="px-4 w-full md:w-2/12 mb-4 md:mb-0 accordion">
          <h5 class="text-lg text-blue font-semibold mb-2 relative">Explore</h5>
          <ul class="h-0 invisible md:h-auto md:visible overflow-hidden">
            <li>
              <a href="#" class="hover:underline py-1 block text-blue-light"
                >Terms & Conds</a
              >
            </li>
            <li>
            ...
            <li>
              <a href="#" class="text-blue-light hover:underline py-1 block text-blue-light"
                >For Developer</a
              >
            </li>
          </ul>
        ...
        <div class="px-4 w-full md:w-3/12 mb-4 md:mb-0">
          <h5 class="text-lg text-blue font-semibold mb-2 relative">
            Special Letter
          </h5>
          <form action="#">
            <label class="relative w-full">
              ...
              />
              <button class="bg-blue-light absolute rounded-xl right-0 p-3">
                <svg
                  width="24"
                  height="24"
                  viewBox="0 0 24 24"
...
<footer class="flex text-center px-4 py-8 justify-center">
  <p class="text-sm text-blue">
    Copyright 2021 • All Rights Reserved Zhafirah Catering by M Reyhan Dwi Amberta
  </p>
</footer>
<!-- END: FOOTER -->
